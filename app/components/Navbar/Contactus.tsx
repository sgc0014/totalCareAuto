...
const Contactusform = ({altButton,altActiveButton}: {altButton?: boolean; altActiveButton?: boolean}) => {
      ...
      <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
        ...
        <div className="hidden lg:block">
          {altButton ? (
            ...
            className="text-xl py-5 px-14 mt-5 font-semibold text-white rounded-full bg-gold border border-gold hover:bg-gold">
              {" "}
         ...
         : altActiveButton ? (
            <button
            type="button"
            className="justify-end text-xl font-semibold py-4 px-6 lg:px-12 navbutton rounded-full bg-gold "
            onClick={openModal}
          >
            Contact Us
          </button> 
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                    ...
                    <p className="mb-8 lg:mb-16 mt-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
                      Contact us now. Let us service you.
                    </p>
                    <form
                      action="#"
                      className="space-y-8"
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={handleClick}
                        disabled={isDisabled}
                        className="py-3 px-5 text-sm disabled:opacity-50 font-medium w-full text-center text-white rounded-lg bg-gold focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                      >
                        Send message
                      </button>
                    </form>
